    ...
    <x-slot name="header">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6 lg:p-8">
                        ...
                        <form method="POST" action="{{ route('fiels.store')}}" class="formulario-crear" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                            <div class="mb-5 row">
                                <div class="col-sm">
                                <label for="id_documento" class="block mb-2 text-l font-medium text-gray-900 dark:text-black">Documento de identidad</label>
                                <input type="text" name="id_documento" id="id_documento" class=" border border-gray-300 text-gray-900 text-m rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:text-Black dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                                ...
                                <input type="date" name="fecha_de_nacimiento" id="fecha_de_nacimiento" class=" border border-gray-300 text-gray-900 text-m rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:text-Black dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                                <label for="telefono" class="block mb-2 text-l font-medium text-gray-900 dark:text-black">Telefono</label>
                                <input type="text" name="telefono" id="telefono" class=" border border-gray-300 text-gray-900 text-m rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:text-Black dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col mt-4">
                                        <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mb-2">Crear Fiel</button>
