...
<div class="flex flex-col items-center justify-between px-4 py-12 mx-auto max-w-7xl md:flex-row">
    <div>
        ...
        <p class="text-base text-gray-500">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Esse eveniet quis officiis vitae fugit numquam reiciendis consequatur quos, recusandae itaque beatae mollitia. Impedit ex vero sequi illo ab eaque? Ipsa.</p>
  ...
  <div class="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3">
    <div>
      <a href="#">
        <img src="/brand/og.png" class="object-cover w-full h-56 mb-5 bg-center rounded" alt="Kutty" loading="lazy" />
      </a>
    ...
    <div>
      <a href="#">
        <img src="/brand/og-white.png" class="object-cover w-full h-56 mb-5 bg-center rounded" alt="Kutty" loading="lazy" />
      </a>
      <h2 class="mb-2 text-lg font-semibold text-gray-900">
