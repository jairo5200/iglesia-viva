@foreach ( $noticias as $noticia )
    <div>
      <a href="{{route('noticia', $noticia->id)}}">
        ...
        <img src="/imagen/{{$noticia->imagen}}" class=" w-full h-60 mb-1 bg-center rounded" alt="imagen-noticia"/>
      </a>
      <p class="mb-3 text-sm font-normal text-gray-500">
        <a href="#" class="font-medium text-gray-900 hover:text-purple-700">{{$noticia->user->name}}</a>
