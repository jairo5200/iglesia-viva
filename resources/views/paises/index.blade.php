...
<x-app-layout>
    ...
    <x-slot name="header">
        ...
        <a href="{{ route('paises.create') }}" class="text-white bg-slate-700 hover:bg-slate-800 focus:ring-4 focus:outline-none focus:ring-slate-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-slate-800 dark:hover:bg-slate-700 dark:focus:ring-slate-800">{{ __('Crear Pais') }}</a>
        </div>
            ...
            <div class="mt-10">
                <table class="table-auto w-full">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="border px-4 py-2 text-gray-900 dark:text-black text-center">{{ $pais->id }}</td>
