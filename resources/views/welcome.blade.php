...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <a href="https://api.whatsapp.com/send?phone=+573215719000&text=Hola, me gustaria Obtener más información" class="float" target="_blank">
  ...
  <div class="flex items-center justify-between mx-auto max-w-7xl">
    ...
    <div class="flex items-center space-x-1">
      <div class="hidden space-x-1 md:inline-flex">
        <a href="{{route('inicio')}}" class="px-2 lg:px-6 py-6 font-bold text-m border-b-2 border-transparent hover:border-white leading-[22px] md:px-3 text-gray-500 hover:text-white">Inicio</a>
        <a href="#" class="px-2 lg:px-6 py-6 font-bold text-m border-b-2 border-transparent hover:border-white leading-[22px] md:px-3 text-gray-500 hover:text-white">Nosotros</a>
        <a href="#" class="px-2 lg:px-6 py-6 font-bold text-m border-b-2 border-transparent hover:border-white leading-[22px] md:px-3 text-gray-500 hover:text-white">Servicios</a>
        <a href="#" class="px-2 lg:px-6 py-6 font-bold text-m border-b-2 border-transparent hover:border-white leading-[22px] md:px-3 text-gray-500 hover:text-white">Escuelas de formacion ministerial</a>
        <a href="{{route('blogsPagina')}}" class="px-2 lg:px-6 py-6 font-bold text-m border-b-2 border-transparent hover:border-white leading-[22px] md:px-3 text-gray-500 hover:text-white">Blogs</a>
        <a href="#" class="px-2 lg:px-6 py-6 font-bold text-m border-b-2 border-transparent hover:border-white leading-[22px] md:px-3 text-gray-500 hover:text-white">Donde estamos ubicados</a>
      </div>
      @if (Route::has('login'))
            @auth
                <a href="{{ url('/dashboard') }}" class="rounded-md bg-white text-gray-500 px-6 py-2 font-medium hover:bg-black  hover:text-amber-400">Dashboard</a>
            @else
                <a href="{{ route('login') }}" class="rounded-md bg-white text-gray-500 px-6 py-2 font-medium hover:bg-black  hover:text-amber-400">Ingresar</a>
            @endauth
        @endif
      <div class="inline-flex md:hidden" x-data="{ open: false }">
        ...
        <div class="absolute top-0 left-0 right-0 z-50 flex flex-col p-2 pb-4 m-2 space-y-3 bg-white rounded shadow mx-auto" x-show.transition="open" @click.away="open = false" x-cloak>
          <button class="self-end flex-none px-2 ml-2 btn btn-link btn-icon text-black" @click="open = false">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
              ...
              aria-hidden="true"
            >
              <line x1="18" y1="6" x2="6" y2="18" class="text-amber-400"></line>
              <line x1="6" y1="6" x2="18" y2="18"></line>
            </svg>
            <span class="sr-only">Close Menu</span>
          </button>
          <a href="{{route('inicio')}}" class="px-2 lg:px-6 py-6 text-sm font-bold border-b-2 border-transparent hover:border-amber-400 leading-[22px] md:px-3 text-gray-500 hover:text-amber-400">Inicio</a>
          <a href="#" class="px-2 lg:px-6 py-6 text-sm font-bold border-b-2 border-transparent hover:border-amber-400 leading-[22px] md:px-3 text-gray-500 hover:text-amber-400">Nosotros</a>
          <a href="#" class="px-2 lg:px-6 py-6 text-sm font-bold border-b-2 border-transparent hover:border-amber-400 leading-[22px] md:px-3 text-gray-500 hover:text-amber-400">Servicios</a>
          <a href="#" class="px-2 lg:px-6 py-6 text-sm font-bold border-b-2 border-transparent hover:border-amber-400 leading-[22px] md:px-3 text-gray-500 hover:text-amber-400">Escuelas de formacion ministerial</a>
          <a href="{{route('blogsPagina')}}" class="px-2 lg:px-6 py-6 text-sm font-bold border-b-2 border-transparent hover:border-amber-400 leading-[22px] md:px-3 text-gray-500 hover:text-amber-400">Blogs</a>
          <a href="#" class="px-2 lg:px-6 py-6 text-sm font-bold border-b-2 border-transparent hover:border-amber-400 leading-[22px] md:px-3 text-gray-500 hover:text-amber-400">Donde estamos ubicados</a>
        </div>
      </div>
    </div>
  </div>
  <div class="flex mx-auto max-w-7xl sm:justify-end space-x-6">
        ...
        <a class="text-gray-500 hover:text-white" aria-label="Visit TrendyMinds YouTube" href="" target="_blank"><svg
